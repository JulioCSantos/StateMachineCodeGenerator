...
namespace LaserProc.LaserProcSystem
{
    public partial class CLaserProcStateMachine
    {
        ...
        private NSFChoiceState          oIsLocated4_;

        // State Machine ActiveState State Definitions
        private NSFChoiceState          oIsLocated3_;
        ...
        private NSFChoiceState          oIsProcessingRequested_;
        ...
        private NSFChoiceState          oIsLoaded2_;
        private NSFCompositeState       oMoveToRunPosState;
        private NSFCompositeState       oMoveToLoadPosState;
        private NSFChoiceState          oIsLoaded_;
        private NSFChoiceState          oIsLocated_;
        ...
        private NSFChoiceState          oMoreLocations_;
